      ...
      <main>
        ...
        <section className="categories section">
          <div className="container">
            <h2 className="text-center section-title">Popular Categories</h2>
            <div className="categories-grid">
              <div className="category-card" onClick={() => { onSearch('JCB'); onNavigate('find-jobs'); }}>
                ...
                <h3>JCB Operator</h3>
                <p>Find experienced JCB operators for your construction needs.</p>
              </div>
              <div className="category-card" onClick={() => { onSearch('Crane'); onNavigate('find-jobs'); }}>
                ...
                <p>Hire skilled crane operators for heavy lifting and logistics.</p>
              </div>
          ...
          <div className="container">
            ...
            <div className="steps-grid">
              <div className="step-card">
                ...
                <h3>Register</h3>
                <p>Create your profile as a worker or a contractor easily.</p>
              </div>
              <div className="step-card">
                <div className="step-num">2</div>
                <h3>Search</h3>
                <p>Find jobs or workers matching your specific location and needs.</p>
              </div>
              <div className="step-card">
                <div className="step-num">3</div>
                <h3>Connect</h3>
                <p>Contact directly and get the work done efficiently.</p>
              </div>
            </div>
          </div>
        </section>
